...
export class MyReactEnvMain {
  ...
  static async provider([react, envs]: [ReactMain, EnvsMain]) {
    ...
    const MyReactEnvEnv = react.compose([
      /**
    ...
    envs.registerEnv(MyReactEnvEnv);
    return new MyReactEnvMain();
  }
}

MyReactEnvAspect.addRuntime(MyReactEnvMain);
